...
<head>
<link rel="StyleSheet" href="../avance_acad/estilos.css" type="text/css"> 
<script language="javascript" src="../avance_acad/jquery.js" type="text/javascript"></script>
<script language="javascript" src="../avance_acad/tablesort.js" type="text/javascript"></script>
...
<body>
<?php
require_once('../avance_acad/inc/config.php');//este tambien esta agregado en cada funcion
require_once("../avance_acad/inc/odbcss_c.php");

$codigos=$_POST['codigos'];

//if($_SERVER['HTTP_REFERER']!=$raizDelSitio.'visual.php' && $_SERVER['HTTP_REFERER']!=$raizDelSitio.'planilla_r.php' && $_SERVER['HTTP_REFERER']!=$raizDelSitio.'cante.php' && $_SERVER['HTTP_REFERER']!=$raizDelSitio.'guardar.php' && $_SERVER['HTTP_REFERER']!=$raizDelSitio.'introt.php' && $_SERVER['HTTP_REFERER']!=$raizDelSitio.'cargac.php' && $_SERVER['HTTP_REFERER']!=$raizDelSitio.'cerrar.php' && $_SERVER['HTTP_REFERER']!=$raizDelSitio.'visual_s.php' ) die ("<script languaje=\"javascript\"> alert('ACCESO PROHIBIDO!'); </script>");
...
for($i=0;$i<$cantialu;$i++) {
	$exp_e[$i]=$alu[$i][0];// LLena el arreglo de expedientes

	for($j=1;$j<=$ccca;$j++) {
		$nnota[36][$i]=$nnota[36][$i] + $nnota[$j][$i];// Carga el total para NOTA100
	}
		
	
	$nnota[37][$i]=conva9(round($nnota[36][$i]));// Carga el total para NOTA9
}
...
if($result[0][0]!=NULL)
{
	$conex->iniciarTransaccion("Inicia Transaccion: ACTA: ".$nacta.", C_ASIGNA: ".$nc_asigna);
	for($k=0;$k<$cantialu;$k++)	{// Esta rutina se ejecuta desde carga de calificacion
				//print_r($_POST);
				
				$exp_e =  $_POST['exp_'.$k];
				$mSQL = "UPDATE N_ESTU SET UCCA='$ucca', CCCA='$ccca', NOTA".$ucca."='".$_POST['nota'.$ucca.'-'.$k]."' ";
				/*$mSQL.= "NOTA1='".$_POST['nota1-'.$k]."', NOTA2='".$_POST['nota2-'.$k]."', NOTA3='".$_POST['nota3-'.$k]."', ";
				$mSQL.= "NOTA4='".$_POST['nota4-'.$k]."', NOTA5='".$_POST['nota5-'.$k]."', NOTA6='".$_POST['nota6-'.$k]."', ";
				$mSQL.= "NOTA7='".$_POST['nota7-'.$k]."', NOTA8='".$_POST['nota8-'.$k]."', NOTA9='".$_POST['nota9-'.$k]."', ";
				$mSQL.= "NOTA10='".$_POST['nota10-'.$k]."', NOTA11='".$_POST['nota11-'.$k]."', NOTA12='".$_POST['nota12-'.$k]."', ";
				$mSQL.= "NOTA13='".$_POST['nota13-'.$k]."', NOTA14='".$_POST['nota14-'.$k]."', NOTA15='".$_POST['nota15-'.$k]."', ";
				$mSQL.= "NOTA16='".$_POST['nota16-'.$k]."', NOTA17='".$_POST['nota17-'.$k]."', NOTA18='".$_POST['nota18-'.$k]."', ";
				$mSQL.= "NOTA19='".$_POST['nota19-'.$k]."', NOTA20='".$_POST['nota20-'.$k]."', NOTA21='".$_POST['nota21-'.$k]."', ";
				$mSQL.= "NOTA22='".$_POST['nota22-'.$k]."', NOTA23='".$_POST['nota23-'.$k]."', NOTA24='".$_POST['nota24-'.$k]."', ";
				$mSQL.= "NOTA25='".$_POST['nota25-'.$k]."', NOTA26='".$_POST['nota26-'.$k]."', NOTA27='".$_POST['nota27-'.$k]."', ";
				$mSQL.= "NOTA28='".$_POST['nota28-'.$k]."', NOTA29='".$_POST['nota29-'.$k]."', NOTA30='".$_POST['nota30-'.$k]."', ";
				$mSQL.= "NOTA31='".$_POST['nota31-'.$k]."', NOTA32='".$_POST['nota32-'.$k]."', NOTA33='".$_POST['nota33-'.$k]."', ";
				$mSQL.= "NOTA34='".$_POST['nota34-'.$k]."', NOTA35='".$_POST['nota35-'.$k]."', ";*/
				//$mSQL.= "TOTAL100='".$nnota[36][$k]."', TOTAL9='".$nnota[37][$k]."', STATUS='".$alu[$k][2]."' ";
				$mSQL.= "WHERE ACTA='$nacta' AND LAPSO='$nlapso' AND C_ASIGNA='$nc_asigna' AND EXP_E='".$exp_e."' ";

				$conex->ExecSQL($mSQL,__LINE__,true);

				$tSQL = "SELECT nota1, nota2, nota3, nota4, nota5, nota6, nota7, nota8, nota9, nota10, ";
				$tSQL.= "nota11, nota12, nota13, nota14, nota15, nota16, nota17, nota18, nota19, nota20, ";
				$tSQL.= "nota21, nota22, nota23, nota24, nota25, nota26, nota27, nota28, nota29, nota30, ";
				$tSQL.= "nota31, nota32, nota33, nota34, nota35 FROM n_estu ";
				$tSQL.= "WHERE ACTA='$nacta' AND LAPSO='$nlapso' AND C_ASIGNA='$nc_asigna' AND EXP_E='".$exp_e."' ";
				$conex->ExecSQL($tSQL,__LINE__,true);

				$totales = $conex->result;

				$total100 = array_sum($totales[0]);
				$total9 = conva9(round($total100));// Carga el total para NOTA9

				$uSQL = "UPDATE N_ESTU SET TOTAL100='".$total100."', TOTAL9='".$total9."' ";
				$uSQL.= "WHERE ACTA='$nacta' AND LAPSO='$nlapso' AND C_ASIGNA='$nc_asigna' AND EXP_E='".$exp_e."' ";
	...
	$conex->finalizarTransaccion("Fin Transaccion: ACTA: ".$nacta.", C_ASIGNA: ".$nc_asigna);
	//die();
}
else
{
...
$result = $conex->result;
	if($result[0][0]!=NULL)
	{
		for($k=0;$k<$cantialu;$k++) {// Esta rutina se ejecuta desde modificar calificacion general
			$exp_e =  $_POST['nota0-'.$k];
			$mSQL = "UPDATE N_ESTU SET UCCA='$ucca', CCCA='$ccca', ";
			$mSQL.= "NOTA1='".$_POST['nota1-'.$k]."', NOTA2='".$_POST['nota2-'.$k]."', NOTA3='".$_POST['nota3-'.$k]."', ";
			$mSQL.= "NOTA4='".$_POST['nota4-'.$k]."', NOTA5='".$_POST['nota5-'.$k]."', NOTA6='".$_POST['nota6-'.$k]."', ";
			$mSQL.= "NOTA7='".$_POST['nota7-'.$k]."', NOTA8='".$_POST['nota8-'.$k]."', NOTA9='".$_POST['nota9-'.$k]."', ";
			$mSQL.= "NOTA10='".$_POST['nota10-'.$k]."', NOTA11='".$_POST['nota11-'.$k]."', NOTA12='".$_POST['nota12-'.$k]."', ";
...
/////////////////////////////////////////////////////////////////////////////////////////////
function sacanotasgral($nacta,$nlapso,$nc_asigna) {
require_once("inc/odbcss_c.php");
global $conex;
//$conex = new ODBC_Conn($basededatos,$usuariodb,$clavedb,TRUE,$laBitacora);
$mSQL  = "select b.apellidos||',  '||nombres,a.exp_e,a.NOTA1,a.nota2,a.nota3,a.nota4,a.nota5,a.nota6,a.nota7,a.nota8,a.nota9,a.nota10,a.nota11,a.nota12,a.nota13,a.nota14,a.nota15,a.nota16,a.nota17,a.nota18,a.nota19,a.nota20,a.NOTA21,a.NOTA22,a.NOTA23,a.NOTA24,a.NOTA25,a.NOTA26,a.NOTA27,a.NOTA28,a.NOTA29,a.NOTA30,a.NOTA31,a.NOTA32,a.NOTA33,a.NOTA34,a.NOTA35,a.total100,a.total9,c.status from N_ESTU a,dace002 b,dace006 c where a.acta='$nacta' and a.lapso='$nlapso' and a.C_ASIGNA='$nc_asigna' and a.EXP_E=b.EXP_E and c.acta='$nacta' and c.lapso='$nlapso' and c.C_ASIGNA='$nc_asigna' and a.EXP_E=c.EXP_E and c.status in ('7','A','2','R') order by b.apellidos, b.apellidos2, b.nombres, b.nombres2 asc";
$conex->ExecSQL($mSQL,__LINE__,true);
$result = $conex->result;
return $result;
}
...
global $conex;
//$conex = new ODBC_Conn($basededatos,$usuariodb,$clavedb,TRUE,$laBitacora);
$mSQL  = "select a.exp_e,a.nota1,a.nota2,a.nota3,a.nota4,a.nota5,a.nota6,a.nota7,a.nota8,a.nota9,a.nota10,a.nota11,a.nota12,a.nota13,a.nota14,a.nota15,a.nota16,a.nota17,a.nota18,a.nota19,a.nota20,a.nota21,a.nota22,a.nota23,a.nota24,a.nota25,a.nota26,a.nota27,a.nota28,a.nota29,a.nota30,a.nota31,a.nota32,a.nota33,a.nota34,a.nota35 from N_ESTU a,dace002 b where a.acta='$nacta' and a.lapso='$nlapso' and a.c_asigna='$nc_asigna' and a.EXP_E=b.EXP_E order by b.apellidos, b.apellidos2, b.nombres, b.nombres2 asc";
$conex->ExecSQL($mSQL,__LINE__,true);
$result = $conex->result;
return $result;
}
...
$conex->ExecSQL($mSQL,__LINE__,true);
$result = $conex->result;
$mSQL  = "select status from N_ESTU where acta='$nacta' and lapso='$nlapso' and c_asigna='$nc_asigna' ";
$conex->ExecSQL($mSQL,__LINE__,true);
$datos = $conex->result;
$cont=0;
$agre=0;
...
{
if($datos[$cont][0]=='A') $agre++;
if($datos[$cont][0]=='R' || $datos[$cont][0]=='2') $reti++;
$cont++;
}
$result[0][4]=$agre;
$result[0][5]=$reti;
...
$agregados=array();	
global $conex;
$mSQL  = "select c.EXP_E,b.apellidos||',  '||nombres,c.status from dace006 c,dace002 b where c.acta='$nacta' and c.lapso='$nlapso' and c.c_asigna='$nc_asigna' and c.EXP_E=b.EXP_E and c.status<>'2' and c.status<>'Y' and c.status<>'Z' and c.EXP_E not in (select EXP_E from N_ESTU where acta='$nacta' and lapso='$nlapso' and c_asigna='$nc_asigna')";
...
<table align="center" width="100%">
  	<tr>
    <td width="38%" class="datosp"><strong>DESCRIPCI&Oacute;N DE TEMA:</strong>&nbsp;&nbsp;</td><td class="datosp">'.$tema[$valor].'</td>
 	</tr>
	<tr>
...
{	
	...
	<table width="100%" align="center">
  	<tr>
    <td width="38%" align="right" class="datosp"><strong>CALIFICACI&Oacute;N ACTUAL:</strong>&nbsp;&nbsp;</td><td  class="datosp">'.$resulta[$alu][$eva].'</td>
 	</tr>
	<tr>
    <td width="38%"  class="datosp"><strong>VALOR DE LA EVALUACI&Oacute;N:</strong>&nbsp;&nbsp;</td><td  class="datosp">'.$porc[$eva].'</td>
 	</tr>
	</table>
	';
	}
...
$conex->ExecSQL($mSQL,__LINE__,true);
$todos = $conex->result;// Todos los estudiantes inscritos
...
$conex->ExecSQL($mSQL,__LINE__,true);
$existentes = $conex->result;	// Todos los estudiantes en el avance academico


				$cantalu=0;
				$num=0;
				while($todos[$cantalu][0]!=NULL) { // mientras haya un registro
					
					if($todos[$cantalu][0]!=$existentes[$num][0]) {	// Si el exp de dace006 no es igual al de d_temas				
						for($k=1;$k<=$ulti;$k++) {
							$nota[$cantalu][$k]=0;
						}							
					}
...
if($resultado4!=NULL){	
	for($i=36,$j=1;$i<=70;$i++,$j++){
		$porc[$j]=$resultado4[0][$i];
	}	
}
...
############# OJO CAMBIAR RUTINA DE INSERT A PARTIR DEL SELECT
...
if($codigos==666) //cuando se va a guardar modificacion de la calificacion de un estudiante
{
	...
	//$eva
	$base100=0;
	for($j=1;$j<=$cont1;$j++) $base100=$base100+$nota[$j][$alu];
	$base9=conva9(round($base100));
	$mSQL  ="UPDATE N_ESTU SET NOTA".$eva."='$nc',TOTAL100='$base100',TOTAL9='$base9' WHERE EXP_E='$exp_te' and ACTA='$acta' and LAPSO='$lapso' and C_ASIGNA='$c_asigna'";
$conex->ExecSQL($mSQL,__LINE__,true);
...
$conex = new ODBC_Conn($basededatos,$usuariodb,$clavedb,TRUE,'consulta_listado'.date(m).'-'.date(Y).'.log');
...
$resultado = $conex->result;
			...
			$mSQL.= "WHERE a.lapso='".$lapsoProceso."' and a.c_asigna like ";

			switch ($car) {
				case 1:
					$mSQL.= "'30%' AND a.c_asigna in (SELECT c_asigna FROM D_TEMAS WHERE lapso='".$lapsoProceso."' and c_asigna like '30%') ";
					break;
				case 2:
					$mSQL.= "'31%' AND a.c_asigna in (SELECT c_asigna FROM D_TEMAS WHERE lapso='".$lapsoProceso."' and c_asigna like '31%') ";
					break;
				case 3:
					$mSQL.= "'35%' AND a.c_asigna in (SELECT c_asigna FROM D_TEMAS WHERE lapso='".$lapsoProceso."' and c_asigna like '35%') ";
					break;
				case 4:
					$mSQL.= "'32%' AND a.c_asigna in (SELECT c_asigna FROM D_TEMAS WHERE lapso='".$lapsoProceso."' and c_asigna like '32%') ";
					break;
				case 5:
					$mSQL.= "'33%' AND a.c_asigna in (SELECT c_asigna FROM D_TEMAS WHERE lapso='".$lapsoProceso."' and c_asigna like '33%') ";
					break;
				case 6:
					$mSQL.= "'34%' AND a.c_asigna in (SELECT c_asigna FROM D_TEMAS WHERE lapso='".$lapsoProceso."' and c_asigna like '34%') ";
					break;
			}
...
print <<<TABLA01
		...
		<thead>
			<tr style="font-weight:bold;background-color:#000000;color:#FFFFFF;font-size:12px;border-collapse:collapse;">
				...
				<th style="padding-top:3px;padding-bottom:3px;">IMPRIMIR</th>
			</tr>
		</thead>
		<tbody>
TABLA01;
...
print <<<TABLA022
		...
		<td style="text-align:center;padding-right:5px;padding-left:5px;font-size:10px;">
			<input type="button" value="Ver Listado" onclick="window.open('listado.php?acta=$acta&cedula=$cedula&nombre=$nombre','listado','left=0,top=0,width=790,height=500,scrollbars=1,resizable=1,status=1');">
		</td>
	</tr>
TABLA022;
...
//	print_r($_POST);
	...
	$c_asigna=$_POST['c_asigna'];
	$mSQL  = "select seccion from tblaca004 where c_asigna='$c_asigna' AND lapso='".$lapsoProceso."' order by seccion asc";
	$conex->ExecSQL($mSQL,__LINE__,true);
	...
	<select name="selectsec" id="selectsec" class="select.peq" OnChange="fajax('guardar.php','opcion','codigos=112234&seccion='+this.value+'&c_asigna=<?PHP echo $c_asigna; ?>','post','0');">
            <option value="" selected="selected">&lt;&lt; SECCION &gt;&gt;</option> <?PHP				
	$cant=0;
...
{	
	...
	<select name="selectsec" id="selectsec" class="select.peq" OnChange="fajax('guardar.php','visual','codigos=112235&opcion='+this.value+'&c_asigna=<?PHP echo $c_asigna; ?>&acta=<?PHP echo $acta; ?>&lapso=<?PHP echo $lapsoProceso; ?>','post','0');">
			...
			<option value="1">Avance Acad&eacute;mico</option> 
...
<table>
  ...
  <tr><td><?PHP include("datosdemate.php"); ?></td></tr>
  <tr>
	...
	<hr size="1">
		...
		echo '<u>Se realizo en la evaluaci&oacute;n Nro</u> :&nbsp;'.$modct[$cont][7].'<br>';
	...
	<hr size="1">
		...
		echo '<u>Fecha en que se elimino la evaluaci&oacute;n</u> :&nbsp;'.implode("/",array_reverse(explode("-",$modct[$cont][8]))).'<br>';
		echo '<hr size="1">';
		}
		$cont++;
		}
	...
	<tr><td class="datona">
	<p class="encna"><strong>MODIFICACIONES A LA DESCRIPCI&Oacute;N DE LOS TEMAS</strong></p>
	<hr size="1">
		<?php
		//require_once("inc/odbcss_c.php");
		$cont=0;
		while($modt[$cont][4]!=NULL){
		echo '<u>Se realizo en la evaluaci&oacute;n Nro</u> :&nbsp;'.$modt[$cont][3].'<br>';
		echo '<u>Raz&oacute;n de el cambio</u> :&nbsp;'.$modt[$cont][0].'<br>';
		echo '<u>Descripcion original</u> :&nbsp;'.$modt[$cont][1].'<br>';
		echo '<u>Descripcion modificada</u> :&nbsp;'.$modt[$cont][2].'<br>';
		echo '<u>Fecha de modificaci&oacute;n</u> :&nbsp;'.implode("/",array_reverse(explode("-",$modt[$cont][4]))).'<br>';
		echo '<hr size="1">';
		$cont++;
		}
	?>
	...
	<hr size="1">
		...
		echo '<u>Se realizo en la evaluaci&oacute;n Nro</u> :&nbsp;'.$modp[$cont][3].'<br>';
		echo '<u>Raz&oacute;n de el cambio</u> :&nbsp;'.$modp[$cont][0].'<br>';
	...
	echo '<u>Se realizo en la evaluaci&oacute;n Nro</u> :&nbsp;'.$modn[$cont][3].'<br>';
	echo '<u>Fecha de modificaci&oacute;n</u> :&nbsp;'.implode("/",array_reverse(explode("-",$modn[$cont][5]))).'<br>';
	echo '<hr size="1">';
	$cont++;
	}
	?>
