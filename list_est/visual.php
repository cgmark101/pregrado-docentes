...
<html>
<head>
<title>Sistema de Consulta de Listados</title>
<!-- <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1"> -->
<meta content="text/html; charset=UTF-8" http-equiv="Content-Type" />
<link rel="StyleSheet" href="../avance_acad/estilos.css" type="text/css"> 
<script language="javascript" src="../avance_acad/asrequest.js" type="text/javascript"></script>
<script language="javascript" src="../avance_acad/funciones.js" type="text/javascript"></script>
...
<?PHP
//require_once('../avance_acad/inc/config.php');
  ...
  <tr>
	...
	<table border="0" width="100%">
		...
		<font style="font-size:2px;">&nbsp; </font></td></tr>
			...
			<tr>
				<td class="enc_p" colspan="2">SISTEMA DE CONSULTA DE LISTADOS</td>
			</tr>
	</td>
  </tr>
</td></tr>
<tr>
    ...
    <p align="center" class="titulo">Se encuentra en el modulo de visualizacion de listados</p><br><p align="center" class="titulo"> A continuaci&oacute;n se muestra el listado de asignaturas disponibles. </p>
	</td>
  </tr>
  <tr>
...
if(($cargo==21) || ($cargo==22)) { // Jefatura Mecanica
	$car=4;
	$cod=124;
}

if(($cargo==31) || ($cargo==32)) { // Jefatura Electrica
	$car=2;
	$cod=124;
}
...
if(($cargo==51) || ($cargo==52)) { // Jefatura Electronica
	$car=3;
	$cod=124;
}

if(($cargo==61) || ($cargo==62)) { // Jefatura Insdustrial
	$car=6;
	$cod=124;
}

if(($cargo==71) || ($cargo==72)) { // Jefatura Est. Generales
	$car=1;
	$cod=124;
}
...
<?PHP
if($cod==124) {
$conex = new ODBC_Conn($basededatos,$usuariodb,$clavedb,TRUE,'consulta_listado_'.date(m).'-'.date(Y).'.log');
...
for ($i=0;$i < count($resultado);$i++){
	...
	$nasig = substr($conex->result[0][3],0,20);
...
<?PHP
		...
		<tr>
			...
			NO HAY LISTADO DE ESTUDIANTES EN ESTE DEPARTAMENTO.
			</td>
		</tr>
		</table>
TABLA01;
