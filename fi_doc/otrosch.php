...
<title><?php echo $tProceso?> > Cargos Anteriores</title>
...
<form name="datos_mh" method="POST" action="registraroch.php">
	<?for ($i=1;$i<=$cargos;$i++){
		?>
		...
		<BR><div class="tit14" style="text-align:center;">
			...
			(Coloque los datos completos en todos los campos.)</span>
				...
				$mSQL = "select CARGO,DESDE,HASTA ";
				$mSQL= $mSQL."from DOTROS_CH ";
				...
				print "<tr>";
					if(isset($c[0])) {
					print "<td><div><select name='" . "cargo_" . $i ."' id=\"jefatura\" class=\"datospf\" style='width: 190px;>'";
						print "<option value=\"$c[0]\">$c[0]</option>";
						print "<option value=\"COORD CATEDRA\">COORDINADOR DE CATEDRA</option>";
						print "<option value=\"JEFE SECC\">JEFE DE SECCION</option>";
						print "<option value=\"JEFE COORD\">JEFE DE COORDINACION</option>";
						print "<option value=\"JEFE DPTO\">JEFE DE DEPARTAMENTO</option>";
						print "<option value=\"JEFE UNID\">JEFE DE UNIDAD</option>";
						print "<option value=\"DIR INV POST\">DIR. INVEST. Y POSTG.</option>";
						print "<option value=\"DIR ADM\">DIRECTOR ADMINISTRATIVO</option>";
						print "<option value=\"DIR ACAD\">DIRECTOR ACADEMICO</option>";
						print "<option value=\"VICERRECTOR\">VICERRECTOR REGIONAL</option>";
						print "<option value=\"VICE ADM\">VICERRECTOR ADMINISTRATIVO</option>";
						print "<option value=\"VICE ACAD\">VICERRECTOR ACADEMICO</option>";
						print "<option value=\"SECRETARIO\">SECRETARIO</option>";
						print "<option value=\"RECTOR\">RECTOR</option>";
					print "</select><INPUT TYPE='hidden' NAME='update' value='SI'></div></td>";
						...
						print "<td><div><select name='" . "cargo_" . $i ."' id=\"jefatura\" class=\"datospf\" style='width: 190px;>'";
							...
							print "<option value=\"SECRETARIO\">SECRETARIO</option>";
							print "<option value=\"RECTOR\">RECTOR</option>";
						print "</select><INPUT TYPE='hidden' NAME='update' value='NO'></div></td>";
					}
					if(isset($c[1])) {
						print "<td><div><input name='" . "desde_" . $i ."' class=\"datospf\" style='width: 60px;' onClick=\"c1.popup('" . "desde_" . $i ."');\" readonly=\"readonly\" value='$c[1]'>&nbsp;&nbsp;<IMG SRC=\"Builder/img/cal.gif\" WIDTH=\"16\" HEIGHT=\"16\" BORDER=\"0\" onClick=\"c1.popup('" . "desde_" . $i ."');\"></div></td>";
					}
					else {
					...
					if(isset($c[2])) {
						print "<td><div><input name='" . "hasta_" . $i ."' class=\"datospf\" style='width: 60px;' onClick=\"c1.popup('" . "hasta_" . $i ."');\" readonly=\"readonly\" value='$c[2]'>&nbsp;&nbsp;<IMG SRC=\"Builder/img/cal.gif\" WIDTH=\"16\" HEIGHT=\"16\" BORDER=\"0\" onClick=\"c1.popup('" . "hasta_" . $i ."');\"></div></td>";
					}
					else {
