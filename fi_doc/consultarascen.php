		...
		<BR><div class="tit14" style="text-align:center;">
			<HR width="600" align="center">Trabajo <?print $i ?> Datos Generales:<HR width="600" align="center">
				...
				print "<tr class=\"datosp\">";
					print "<td td colspan=\"3\"><div>$a[0]</div></td>";	
				print "</tr>";
				

				print "<tr>";
					print "<td class=\"datosp2\" style=\"width: 160px\">Nivel al que aspira:</td>";
					print "<td class=\"datosp2\" style=\"width: 60px\">Fecha de Aprobaci&oacute;n:</td>";
					print "<td class=\"datosp2\" style=\"width: 160px\">N&uacute;mero Resoluci&oacute;n:</td>";
				print "</tr>";
				print "<tr class=\"datosp\">";
					print "<td><div>$a[1]</div></td>";
					print "<td style='width: 220px;'>$a[2]</div></td>";
					print "<td><div>$a[3]</div></td>";
