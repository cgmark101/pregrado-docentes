...
<form name="datos_preg" method="POST" action="registrarpreg.php">
	<?for ($i=1;$i<=$preg;$i++){
		...
		<TABLE id="datos_preg" align="center" border="0" cellpadding="0" cellspacing="1" 
		 width="600" style="border-collapse:collapse;border-color: blue; border-style:solid; background:#D2DEF0;">
		<BR><div class="tit14" style="text-align:center;">
			<HR width="600" align="center">Pregrado <?print $i ?> Datos Generales:<HR width="600" align="center">
		</div>
				<tr class="datosp2">
				...
				foreach($pre as $p){}
				print "<tr>";
					print "<td colspan=\"3\" class=\"datosp\"><div>$p[0]</div></td>";
				print "</tr>";
				
					print "<td class=\"datosp2\" style=\"width: 260px\">Ciudad:&nbsp;<div class=\"datosp\">$p[1]</div></td>";
					print "<td class=\"datosp2\" colspan=\"2\" style=\"width: 60px\">Pais:&nbsp;<div class=\"datosp\">$p[2]</div></td>";
				print "</tr>";
				
				print "<tr>";
					print "<td class=\"datosp2\" style=\"width: 60px\">T&iacute;tulo Obtenido:</td>";
					print "<td class=\"datosp2\" style=\"width: 260px\">Menci&oacute;n:</td>";
					print "<td class=\"datosp2\" style=\"width: 300px\">Año de Egreso:</td>";
				print "</tr>";
				
				print "<tr class=\"datosp\">";
					print "<td><div>$p[3]</div></td>";
					print "<td><div>$p[4]</div></td>";
					print "<td><div>$p[5]</div></td>";
