...
<form name="datos_preg" method="POST" action="registrarpostg.php">
	<?for ($i=1;$i<=$postgrados;$i++){
		...
		<BR><div class="tit14" style="text-align:center;">
			<HR width="600" align="center">Postgrado <?print $i ?> Datos Generales:<HR width="600" align="center">
				...
				print "<tr>";
					print "<td class=\"datosp2\" style=\"width: 60px\">Ciudad:&nbsp;<div class=\"datosp\">$p[1]</div></td>";
					print "<td class=\"datosp2\" style=\"width: 160px\">Pais:&nbsp;<div class=\"datosp\">$p[2]</div></td>";
					print "<td class=\"datosp2\" style=\"width: 160px\">Año de Egreso:&nbsp;<div class=\"datosp\">$p[5]</div></td>";
				print "</tr>";
				
				print "<tr>";
					print "<td class=\"datosp2\" style=\"width: 160px\">T&iacute;tulo Obtenido:</td>";
					print "<td class=\"datosp2\" style=\"width: 60px\">Menci&oacute;n:</td>";
					print "<td class=\"datosp2\" style=\"width: 60px\">Menci&oacute;n Honorifica:</td>";
