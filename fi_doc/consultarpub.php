...
<form name="datos_publi" method="POST" action="registrarpub.php">
	<?for ($i=1;$i<=$publi;$i++){
		?>
		<TABLE id="datos_publi" align="center" border="1" cellpadding="0" cellspacing="1" 
		...
		<BR><div class="tit14" style="text-align:center;">
			<HR width="600" align="center">Publicaci&oacute;n <?print $i ?> Datos Generales:<HR width="600" align="center">
			
		</div>
				<tr>
					<td class="datosp2" style="width: 60px">
						Tipo:
					</td>
					<td class="datosp2" style="width: 60px" colspan="2">
						Casa Editorial:
					</td>
				</tr>
				<?
				...
				print "<tr class=\"datosp\">";
					print "<td><div>$p[0]</div></td>";
					print "<td colspan=\"2\"><div>$p[2]</div></td>";
				print "</tr>";
				
				print "<tr>";
					print "<td class=\"datosp2\" style=\"width: 60px\" colspan=\"3\">Titulo de la Publicaci&oacute;n:</td>";
				print "</tr>";
				print "<tr class=\"datosp\">";
					print "<td  colspan=\"3\"><div>$p[3]</div></td>";
				print "</tr>";
				
				print "<tr>";
					print "<td class=\"datosp2\" style=\"width: 200px\">Fecha de Publicaci&oacute;n:</td>";
					print "<td class=\"datosp2\" style=\"width: 100px\">Ciudad:</td>";
					print "<td class=\"datosp2\" style=\"width: 100px\">Pais:</td>";
				print "</tr>";
				print "<tr class=\"datosp\">";
					print "<td style='width: 60px;'><div>$p[1]</div></td>";
					print "<td style='width: 60px;'><div>$p[4]</div></td>";
					print "<td style='width: 60px;'><div>$p[5]</div></td>";
				print "</tr>";
				print "<tr class=\"datosp\"><td colspan=\"3\">&nbsp;</td></tr>";
