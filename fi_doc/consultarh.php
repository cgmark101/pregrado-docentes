...
$dSQL     = $dSQL." WHERE ci='$padre' " ;
$Cdatos_p->ExecSQL($dSQL);
foreach($Cdatos_p as $doc){}
?>
<BR>
<table border="0" width="740" id="table1" cellspacing="1" cellpadding="0" style="border-collapse: collapse;border-color:blue;">
	<tr>
...
<HR width="740" align="center">
<table border="0" width="740" id="table1" cellspacing="1" cellpadding="0" style="border-collapse: collapse;border-color:blue;" align="center">
	<tr class="datosp2">
...
<form name="datos_h" method="POST" action="registrarh.php">
	<?for ($i=1;$i<=$hijos;$i++){
		...
		<TABLE id="datos_hijos" align="center" border="0" cellpadding="0" cellspacing="1" 
		 width="740" style="border-collapse:collapse;border-color: white; border-style:solid; background:#FFFFFF;">
		<BR><div class="tit14" style="text-align:center;">
			<HR width="740" align="center">Hijo <?print $i ?> Datos Personales:</div><HR width="740" align="center">
				<tr>
					<td class="datosp2" style="width: 70px">
						Cedula
					</td>
					<td class="datosp2" style="width: 160px">
						Nombres
					</td>
					<td class="datosp2" style="width: 160px">
						Apellidos
				...
				print "<tr class=\"datosp\">";
					...
					print "<td><div>$h[0]</td>";
					print "<td><div>$h[2]</div></td>";
					print "<td><div>$h[1]</div></td>";

				print "</tr>";
				
				print "<tr class=\"datosp\">";

					print "<td class='datosp2' style='width: 120px'>Fecha de Nacimiento</td> ";
					print "<td class='datosp2' style='width: 70px'>Nivel de Estudio</td> ";
					print "<td class='datosp2' style='width: 70px'>Grado / Año / Semestre</td> ";
						
				print "</tr>";
				
				print "<tr class=\"datosp\">";
				
					print "<td><div>$h[3]</div></td>";
					print "<td><div>$h[4]</td>";
					print "<td><div>$h[5]";
					print "</div></td>";
			...
			</TABLE><HR width="740" align="center">
<BR>
		<?
	}
}
