...
<form name="datos_invest" method="POST" action="registrarinves.php">
	<?for ($i=1;$i<=$inves;$i++){
		...
		<BR><div class="tit14" style="text-align:center;">
			<HR width="600" align="center">Investigaci&oacute;n <?print $i ?> Datos Generales:<HR width="600" align="center">
		</div>
				<tr>
					<td style="width: 60px" class="datosp2" colspan="3">
						Nombre del Proyecto:
					</td>
				</tr>
				<?
				...
				print "<tr class=\"datosp\">";
					print "<td td colspan=\"3\">$v[0]</div></td>";	
				print "</tr>";
				
				print "<tr>";
					print "<td class=\"datosp2\" style=\"width: 60px\">Fecha de Inicio:</td>";
					print "<td class=\"datosp2\" style=\"width: 60px\">Linea:</td>";
					print "<td class=\"datosp2\" style=\"width: 60px\">Rol:</td>";
				print "</tr>";

				print "<tr class=\"datosp\">";
					print "<td style=\"width: 60px\"><div>$v[1]</div></td>";
					print "<td style=\"width: 60px\"><div>$v[2]</div></td>";
					print "<td style=\"width: 60px\"><div>$v[3]</div></td>";
				print "</tr>";											
				?>
