...
<form name="datos_concur" method="POST" action="registrarconcur.php">
	<?for ($i=1;$i<=$concur;$i++){
		...
		<BR><div class="tit14" style="text-align:center;">
			<HR width="600" align="center">Concurso <?print $i ?> Datos Generales:<HR width="600" align="center">
			
		</div>
				<tr>
					<td class="datosp2" style="width: 60px" colspan="4">Nombre del Concurso:</td>
				</tr>
				<?
				//CONSULTA DE DATOS ALMACENADOS
				...
				print "<tr class=\"datosp\">";
					print "<td colspan=\"4\" ><div>$c[4]</div></td>";	
				print "</tr>";
				
				print "<tr>";
					print "<td class=\"datosp2\" style=\"width: 60px\" colspan=\"4\">Nombre del Trabajo:</td>";
				print "</tr>";
				
				print "<tr class=\"datosp\">";
					print "<td colspan=\"4\"><div>$c[0]</div></td>";	
				print "</tr>";

				print "<tr>";
					print "<td class=\"datosp2\" style=\"width: 130px\">Fecha de Participaci&oacute;n:</td>";
					print "<td class=\"datosp2\" style=\"width: 100px\">Ciudad:</td>";
					print "<td class=\"datosp2\" style=\"width: 100px\">Pais:</td>";
					print "<td class=\"datosp2\" style=\"width: 100px\">Galard&oacute;n Obtenido:</td>";
				print "</tr>";
				
				print "<tr class=\"datosp\">";
					print "<td style='width: 60px;'><div>$c[1]</div></td>";
					print "<td style='width: 60px;'><div>$c[2]</div></td>";
					print "<td style='width: 60px;'><div>$c[3]</div></td>";
					print "<td style='width: 60px;'><div>$c[5]</div></td>";
				print "</tr>";
