...
<title><?php echo $tProceso?> > Otras Materias</title>
...
<form name="datos_mh" method="POST" action="registrarmh.php">
	<?for ($i=1;$i<=$math;$i++){
		...
		<BR><div class="tit14" style="text-align:center;">
			<HR width="600" align="center">Materia <?print $i ?> Datos Generales:<HR width="600" align="center">
		</div>
				<tr>
					...
					<td class="datosp2" style="width: 50px">
						Nombre &nbsp;Completo:
					</td>
					<td class="datosp2" style="width: 100px">
						En el Lapso:
					</td>
					<td class="datosp2" style="width: 100px">
						Nivel
				...
				print "<tr>";
					...
					print "<td class=\"datosp\"><div>$m[0]</div></td>";
					print "<td class=\"datosp\" style=\"width: 150px\"><div>$m[1]</div></td>";
					print "<td class=\"datosp\"><div>$m[2]</div></td>";
					print "<td class=\"datosp\"><div>$m[3]</td>";
