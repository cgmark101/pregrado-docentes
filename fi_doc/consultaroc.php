...
<form name="datos_oc" method="POST" action="registraroc.php">
	<?for ($i=1;$i<=$cargos;$i++){
		?>
		<TABLE id="datos_och" align="center" border="1" cellpadding="0" cellspacing="1" 
		...
		<BR><div class="tit14" style="text-align:center;">
			<HR width="600" align="center">Cargo <?print $i ?> Datos Generales:<HR width="600" align="center">
		</div>
				<tr>
					<td class="datosp2" style="width: 160px" colspan="3">
						Nombre del Cargo:
					</td>
				</tr>
				<?
				...
				print "<tr>";
					print "<td  colspan=\"3\" class=\"datosp\">$c[0]</div></td>";
				print "</tr>";

				print "<tr>";
					print "<td class=\"datosp2\">Empresa:</td>";
					print "<td class=\"datosp2\">Desde:</td>";
					print "<td class=\"datosp2\">Hasta:</td>";
				print "</tr>";
		 				
				print "<tr class=\"datosp\">";
					print "<td><div>$c[1]</div></td>";
					print "<td><div>$c[2]</div></td>";
					print "<td><div>$c[3]</div></td>";
