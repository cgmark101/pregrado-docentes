...
<form name="datos_cursos" method="POST" action="registrarcursos.php">
	<?for ($i=1;$i<=$cursos;$i++){
		...
		<BR><div class="tit14" style="text-align:center;">
			<HR width="600" align="center">Curso <?print $i ?> Datos Generales:<HR width="600" align="center">
		</div>
				<tr>
				...
				foreach($cur as $c){}
				print "<tr>";
					print "<td  colspan=\"3\" class=\"datosp\"><div>$c[0]</div></td>";
				print "</tr>";
				
				print "<tr>";
					print "<td class=\"datosp2\" style=\"width: 160px\" colspan=\"2\">Nombre del Curso:</td>";
					print "<td class=\"datosp2\" style=\"width: 60px\">Fecha:</td>";
				print "</tr>";
				print "<tr>";
					print "<td  colspan=\"2\" class=\"datosp\"><div>$c[1]</div></td>";
					print "<td style='width: 120px;' class=\"datosp\"><div>$c[5]</div></td>";
				print "</tr>";
				
				print "<tr>";
					print "<td class=\"datosp2\" style=\"width: 60px\">Ciudad:&nbsp;<div class=\"datosp\">$c[2]</div></td>";
					print "<td class=\"datosp2\" style=\"width: 60px\">Pais:&nbsp;<div class=\"datosp\">$c[3]</div></td>";
					print "<td class=\"datosp2\" style=\"width: 60px\">Duraci&oacute;n:&nbsp;<div class=\"datosp\">$c[4]&nbsp;horas</div></td>";
