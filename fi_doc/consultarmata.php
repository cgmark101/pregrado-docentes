...
<form name="datos_m" method="POST" action="registrarm.php">
	<?for ($i=1;$i<=$materias;$i++){
		...
		<BR><div class="tit14" style="text-align:center;">
			<HR width="600" align="center">Materia <?print $i ?> Datos Generales:</div><HR width="600" align="center">
				...
				print "<tr>";
					...
					print "<td class='datosp'><div>$m[1]</div></td>";
					print "<td class='datosp' style='width: 150px'><div>$m[2]</div></td>";
					print "<td class='datosp'><div>$m[3]</div></td>";
					print "<td class='datosp'><div>$m[4]</div></td>";
