<?php
    ...
    function cedula_valida($ced,$clave) {
        ...
        if ($ced != ""){
			...
			$dSQL     = " SELECT ci, nombres, apellidos, cargo";
            $dSQL     = $dSQL." FROM DPERSONALES ";
	...
	$datos_p   = new ODBC_Conn("FDOCENTE","C","C");
	$dSQL     = "SELECT NAC,CI,RESIDENCIA,DOC_IDENT,PASAPORTE_NRO,APELLIDOS,NOMBRES,EMAIL,";
	$dSQL    .= "F_NAC,PAIS_NAC,LUGAR_NAC,EDAD,EDO_C,DIRECCION,TELF_H,TELF_M,SEXO,HIJOS ";
	$dSQL    .= "FROM DPERSONALES ";
	$dSQL    .= "WHERE CI='$dp[0]'";
	$datos_p->ExecSQL($dSQL);
	$cdp=$datos_p->result;
	foreach($cdp as $d){}

	$datos_pa   = new ODBC_Conn("FDOCENTE","C","C");
	$dSQL = "SELECT ING_PUB,ING_UNEXPO,DPTO,ESTATUS,CLASIFICACION,";
	$dSQL.= "DEDICACION,SECCIONES,JEFATURA,OTROS_CARGOS,OTRAS_MATERIAS,OTROS_CARG_H,";
	$dSQL.= "PREGRADOS,POSTGRADOS,CURSOS,PUBLICACIONES,CONCURSOS,INVESTIGACIONES, ";
	$dSQL.= "COMUNITARIOS,ASCENSOS,TT_GRADO ";
	$dSQL.= "FROM DPERFIL_A ";
	$dSQL.= "WHERE CI_D='$dp[0]'";
	$datos_pa->ExecSQL($dSQL);
	$dpa=$datos_pa->result;
	foreach($dpa as $p){}
	
	if (isset($p)){
	if($p[6]>0){$vasig=$p[6];}else{$vasig="0";}
	if($p[8]>0){$vocarg=$p[8];}else{$vocarg="0";}
	if($p[9]>0){$voasig=$p[9];}else{$voasig="0";}
	if($p[10]>0){$vocargh=$p[10];}else{$vocargh="0";}
	if($p[12]>0){$vpost=$p[12];}else{$vpost="0";}
	if($p[13]>0){$vcursos=$p[13];}else{$vcursos="0";}
	if($p[14]>0){$vpubli=$p[14];}else{$vpubli="0";}
	if($p[15]>0){$vconcur=$p[15];}else{$vconcur="0";}
	if($p[16]>0){$vinves=$p[16];}else{$vinves="0";}
	if($p[17]>0){$vcomun=$p[17];}else{$vcomun="0";}
	if($p[18]>0){$vascen=$p[18];}else{$vascen="0";}
	if($p[19]>0){$vtgrad=$p[19];}else{$vtgrad="0";}
	}
...
<table border="0" width="750" id="table1" cellspacing="1" cellpadding="0" 
 style="border-collapse: collapse;border-color:white;">
		 ...
		 width="740" style="border-collapse:collapse;border-color: white; border-style:solid; background:#D2DEF0;">
			...
			<tr>
                ...
                <td style="width: 150px;" border="1;" >
					 ...
					 class="datospf" style="width: 70px; display:none;" type="text" onKeyUp="validarN(this);" onChange="validar(this);" value="$d[4]">
				</td>
            </tr>
            ...
            <tr>
				<td style="width: 220px;" >
					<input name="apellidos" id="Apellidos" maxlength="25"  
					 ...
					 value="$dp[2]" onKeyUp="validarL(this);">
				</td>
                <td style="width: 220px;" >
					<input name="nombres" id="Nombres" maxlength="25" alt="Nombres" 
					 class="datospf" style="width: 200px;" type="text" 
					 value="$dp[1]" onKeyUp="validarL(this);">
				</td>

				<td style="width: 220px;" >
					<input name="correo_e" id="Correo Electr&oacute;nico" maxlength="30" class="datospf" style="width: 200px;" type="text" value="$d[7]">
				</td>
                
                <td style="width: 150px;" >
					<input name="cargo" id="Cargo" maxlength="25" alt="cargo" 
					 class="datospf" style="width: 200px;" type="hidden" 
					 value="$dp[3]" onKeyUp="validarL(this);">
				</td>
            </tr>
            ...
            <tr>
				<td class="datosp" style="width: 220px;" >
					<input name="f_nac" class="datospf" style="width: 60px;" onClick="c1.popup('f_nac');" readonly="readonly" value="$d[8]">&nbsp;&nbsp;<IMG SRC="Builder/img/cal.gif" WIDTH="16" HEIGHT="16" BORDER="0" onClick="c1.popup('f_nac');">
				</td>
                <td style="width: 220px;" >
					<input name="p_nac_e" maxlength="30" id="pnac_L_4" alt="Pais de Nacimiento"
						 class="datospf" style="width: 200px;" type="text" onKeyUp="validarL(this);" onChange="validar(this);" value="$d[9]">
				</td>
                <td style="width: 150px;" >
					<input name="l_nac_e" maxlength="30" id="lnac_L_3" alt="Lugar de Nacimiento"
						 class="datospf" style="width: 130px;" type="text" onKeyUp="validarL(this);" onChange="validar(this);" value="$d[10]">
				</td>
            ...
            <tr>
				<td class="datosp" style="width: 220px;" >
					<input name="edad" type="text" class="datospf"; id="edad" style="width: 20px; font-weight:bold;" value="$d[11]" readonly="readonly">
						 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<td style="width: 220px;" >
					<INPUT TYPE="text" NAME="c_hijos" id="hijos" class="datospf" maxlength="2" style="width: 30px;" onKeyUp="validarN(this);" value="$d[17]">
					
					<INPUT TYPE="hidden" id="padre" value="$dp[0]">
				
					<INPUT TYPE="button" id="datos" value="incluir datos" class="boton" style="width: 90px;" onClick="with(document.datos_p){ if (c_hijos.value !='0'){enviaA();} else{alert('Disculpe. Cantidad de hijos invalida. Por favor verifique.')}}">
				</td>
            ...
            <tbody>
                <tr class="datosp">
                    <td colspan="2" style="width: 400px;" >
                        Direccion General:</td>
                </tr>
                <tr>
                    <td colspan="4" style="width: 400px;" >
						<input name="direccion" maxlength="200" id="avCalle_A_6" alt="Avenida/Calle" 
						 class="datospf" style="width: 680px;" type="text" 
						 value="$d[13]" onKeyUp="validarA(this);" onChange="validar(this);">
				    </td>
                </tr>
			<tr><td>&nbsp;</td></tr>
                <tr class="datosp">
					...
					<td style="width: 200px;" >
                        Tlf Celular:
						<font style="color:blue;">(Ej: 0000-1234567)</font></td>
                   
                </tr>
                <tr>
                    <td style="width: 200px;" >
						<input name="telefono" maxlength="12" id="telefono_N_7"alt="Telefono (numero)" 
						 class="datospf" style="width: 80px;" type="text" 
						 value="$d[14]" onKeyUp="validarN(this);" onChange="validar(this);">
                    
					<td style="width: 200px;" >
						<input name="celnro" maxlength="12" id="telefono_N_7"alt="Telefono (numero)"  
						 class="datospf" style="width: 80px;" type="text" 
						 value="$d[15]" onKeyUp="validarN(this);" onChange="validar(this);">
        ...
        <table align="center" border="0" cellpadding="1" cellspacing="2" 
		 width="740" style="border-collapse:collapse;border-color:white; border-style:solid; background:#D2DEF0;">
            <tbody>
                ...
                <tr>
                    <td style="width: 85px;">
						<input name="ing_pub" class="datospf" style="width: 60px;" onClick="c1.popup('ing_pub');" readonly="readonly"  value="$p[0]">&nbsp;&nbsp;<IMG SRC="Builder/img/cal.gif" WIDTH="16" HEIGHT="16" BORDER="0" onClick="c1.popup('ing_pub');">
				    </td>
					 <td style="width: 85px;">
						<input name="ing_unexpo" class="datospf" style="width: 60px;" onClick="c1.popup('ing_unexpo');" readonly="readonly" value="$p[1]">&nbsp;&nbsp;<IMG SRC="Builder/img/cal.gif" WIDTH="16" HEIGHT="16" BORDER="0" onClick="c1.popup('ing_unexpo');">
				    </td>
					<td>
					...
					<td>
						<select name="estatus" class="datospf" 
						  style="width: 150px;">
							...
							<option value="ORDINARIO ACTIVO">ORDINARIO ACTIVO</option>
							<option value="CONTRATADO ACTIVO">CONTRATADO ACTIVO</option>
				...
				<tr class="datosp">
					...
					<td style="width: 250px;" colspan="2">Asignaturas que dicta actualmente:</td>
				</tr>
				<tr>
					<td>
						<select name="clasif" id="clasifS" class="datospf" 
					...
					<td>
						<select name="dedic" id="dedicS" class="datospf" 
						  style="width: 145px;">
					...
					<td class="datosp" colspan="2">
						...
						<select name="seccS" id="matS" class="datospf" 
						  style="width: 50px;">
							<option value="$vasig">$vasig</option>
							...
							<INPUT TYPE="button" id="datos" value="incluir datos" class="boton" style="width: 90px;" onClick="with(document.datos_p){ if (seccS.value !='0'){enviaM();} else{alert('Disculpe. Cantidad de materias invalida. Por favor verifique.')}}">
						<SCRIPT LANGUAGE="JavaScript">
						<!--
						function enviaM() {
							var a = document.getElementById("matS").value;
							var b = document.getElementById("ci_N_7").value;
					...
					<td style="width: 190px; color:#D2DEF0;" colspan="2">
						<div id="jefaturaEtq">Indique tipo:<select name="jefatura" id="jefatura" class="datospf" 
							  style="width: 190px; display:block;"
								...
								<option value="COORD CATEDRA">COORDINADOR DE CATEDRA</option>
				...
				<tr class="datosp">
					<td style="width: 100px;">Otros Cargos en la<BR> Adm. P&uacute;blica:</td>
					<td style="width: 200px; color:#D2DEF0;">
						<INPUT TYPE="text" NAME="c_otroc" id="otroc" class="datospf" maxlength="2" style="width: 30px; display:block;" onKeyUp="validarN(this);" value="$vocarg"><INPUT TYPE="button" id="datosotroc" value="incluir datos" class="boton" style="width: 90px; display: block;" onClick="enviaOC();"></td>
    ...
    <td width="750">
        ...
        <table align="center" border="0" cellpadding="1" cellspacing="2" 
		 width="740" style="border-collapse:collapse;border-color:white; border-style:solid; background:#D2DEF0;">
            <tbody>
                <tr class="datosp">
					<td style="width: 150px;">Otras materias en la UNEXPO:&nbsp;</td>
					<td class="datosp" style="width: 30px;">
						<INPUT TYPE="text" NAME="c_math" id="math" class="datospf" maxlength="2" style="width: 30px; display:block;" onKeyUp="validarN(this);" value="$voasig">
					</td>
					<td class="datosp" style="width: 270px;">
						<INPUT TYPE="button" id="datosmh" value="incluir datos" class="boton" style="width: 90px; display: block;" onClick="enviaMH();">
					</td>
				...
				<tr class="datosp">
					<td style="width: 150px;">Ha ejercido otros cargos en la UNEXPO: &nbsp;</td>
					<td class="datosp" style="width: 30px;">
						<INPUT TYPE="text" NAME="c_otroch" id="och" class="datospf" maxlength="2" style="width: 30px; display:block;" onKeyUp="validarN(this);" value="$vocargh">
					</td>
					<td class="datosp" style="width: 270px;">
						<INPUT TYPE="button" id="datosoch" value="incluir datos" class="boton" style="width: 90px; display: block;" onClick="enviaOCH();">
					</td>
    ...
    <td width="750">
        ...
        <table id="dAcad" align="center" border="2" cellpadding="1" cellspacing="2" 
		 width="740" style="border-collapse:collapse;border-color:white; border-style:solid; background:#D2DEF0;">
            <tbody>
                <tr class="datosp">
					<td style="width: 100px;">Cantidad T&iacute;tulos Pregrado:</td>
					<td style="width: 30px;">
						<select name="pregS" id="pregS" class="datospf" 
						  style="width: 35px;">
					...
					<td style="width: 70px;">
						<INPUT TYPE="button" id="datos" value="incluir datos" class="boton" style="width: 90px;" onClick="with(document.datos_p){ if (pregS.value !='0'){enviaPreG();} else{alert('Disculpe. Cantidad invalida. Por favor verifique.')}}">
						<SCRIPT LANGUAGE="JavaScript">
						<!--
						function enviaPreG() {
							var a = document.getElementById("pregS").value;
							var b = document.getElementById("ci_N_7").value;
				...
				<tr class="datosp">
					<td style="width: 100px;">Cantidad Estudios de PostGrado:</td>
					<td class="datosp" style="width: 30px;">
						<INPUT TYPE="text" NAME="c_postg" id="postg" class="datospf" maxlength="2" style="width: 30px; display:block;" onKeyUp="validarN(this);" value="$vpost">
					</td>
					<td class="datosp" style="width: 70px;">
						<INPUT TYPE="button" id="datospostg" value="incluir datos" class="boton" style="width: 90px; display: block;" onClick="enviaPostG();">
					</td>
				...
				<tr class="datosp">
					<td style="width: 100px;">Cantidad de Cursos:</td>
					<td class="datosp" style="width: 30px;">
						<INPUT TYPE="text" NAME="c_cursos" id="cursos" class="datospf" maxlength="2" style="width: 30px; display:block;" onKeyUp="validarN(this);" value="$vcursos">
					</td>
					<td class="datosp" style="width: 70px;">
						<INPUT TYPE="button" id="datoscursos" value="incluir datos" class="boton" style="width: 90px; display:block;" onClick="enviaCUR();">
					</td>
				...
				<tr class="datosp">
					<td style="width: 100px;">Cantidad de Publicaciones:</td>
					<td class="datosp" style="width: 30px;">
						<INPUT TYPE="text" NAME="c_publi" id="publi" class="datospf" maxlength="2" style="width: 30px; display:block;" onKeyUp="validarN(this);" value="$vpubli">
					</td>
					<td class="datosp" style="width: 70px;">
						<INPUT TYPE="button" id="datospubli" value="incluir datos" class="boton" style="width: 90px; display: block;" onClick="enviaPUB();">
					</td>
				...
				<tr class="datosp">
					<td style="width: 100px;">Cantidad de Concursos:</td>
					<td class="datosp" style="width: 30px;">
						<INPUT TYPE="text" NAME="c_concur" id="concur" class="datospf" maxlength="2" style="width: 30px; display:block;" onKeyUp="validarN(this);" value="$vconcur">
					</td>
					<td class="datosp" style="width: 70px;">
						<INPUT TYPE="button" id="datosconcur" value="incluir datos" class="boton" style="width: 90px; display: block;" onClick="enviaCON();">
					</td>
				...
				<tr class="datosp">
					<td style="width: 100px;">Participa en Investigaciones:</td>
					<td class="datosp" style="width: 30px;">
						<INPUT TYPE="text" NAME="c_inves" id="inves" class="datospf" maxlength="2" style="width: 30px; display:block;" onKeyUp="validarN(this);" value="$vinves">
					</td>
					<td class="datosp" style="width: 70px;">
						<INPUT TYPE="button" id="datosinves" value="incluir datos" class="boton" style="width: 90px; display: block;" onClick="enviaIN();">
					</td>
					...
					<td class="datosp" style="width: 30px;">
						<INPUT TYPE="text" NAME="c_comu" id="comu" class="datospf" maxlength="2" style="width: 30px; display:block;" onKeyUp="validarN(this);" value="$vcomun">
					</td>
					<td class="datosp" style="width: 70px;">
						<INPUT TYPE="button" id="datoscomu" value="incluir datos" class="boton" style="width: 90px; display: block;" onClick="enviaCO();">
					</td>
						...
						<SCRIPT LANGUAGE="JavaScript">
							...
							function enviaCO() {
								...
								var b = document.getElementById("ci_N_7").value;
								window.open('comunitarios.php?comu=' + a +'&doc=' + b,'POPUP','toolbar=no,status=no,scrollbars=yes,resizable=no,height=400,width=650,left=110, screenX=0,top=150,screenY=0');
				...
				<tr class="datosp">
					<td style="width: 100px;">Trabajos de Ascenso:</td>
					<td class="datosp" style="width: 30px;">
						<INPUT TYPE="text" NAME="c_tas" id="tas" class="datospf" maxlength="2" style="width: 30px; display:block;" onKeyUp="validarN(this);" value="$vascen">
					</td>
					<td class="datosp" style="width: 70px;">
						<INPUT TYPE="button" id="datostas" value="incluir datos" class="boton" style="width: 90px; display: block;" onClick="enviaTA();">
					</td>
						...
						<SCRIPT LANGUAGE="JavaScript">
							...
							function enviaTA() {
								...
								var b = document.getElementById("ci_N_7").value;
								window.open('ascensos.php?tas=' + a +'&doc=' + b,'POPUP','toolbar=no,status=no,scrollbars=yes,resizable=no,height=400,width=650,left=110, screenX=0,top=150,screenY=0');
				...
				<tr class="datosp">
					<td style="width: 100px;">Tutor de Trabajo de Grado:</td>
					<td class="datosp" style="width: 30px;">
						<INPUT TYPE="text" NAME="c_ttg" id="ttg" class="datospf" maxlength="2" style="width: 30px; display:block;" onKeyUp="validarN(this);" value="$vtgrad">
					</td>
					<td class="datosp" style="width: 70px;">
						<INPUT TYPE="button" id="datosttg" value="incluir datos" class="boton" style="width: 90px; display: block;" onClick="enviaTT();">
					</td>
						...
						<SCRIPT LANGUAGE="JavaScript">
							...
							function enviaTT() {
								...
								var b = document.getElementById("ci_N_7").value;
								window.open('ttesis.php?ttg=' + a +'&doc=' + b,'POPUP','toolbar=no,status=no,scrollbars=yes,resizable=no,height=400,width=650,left=110, screenX=0,top=150,screenY=0');
            ...
            <tbody>
				...
				<tr>
					...
					<td class="datosp" colspan="2">
						n&uacute;mero de secciones:&nbsp;
						<select name="seccS" id="matS" class="datospf" 
						  style="width: 50px;" onChange="with(document.datos_p){ if (this.value !='0'){enviaM();}}">
				...
				<tr class="datosp">
					<td style="width: 350px;">
						<div>Ejerce un Cargo de jefatura en la UNEXPO:</div></td>
					<td>
						<select name="jefaturaS" id="jefaturaS" class="datospf" 
							  style="width: 100px;" onChange="with(document.datos_p){ if (this.value =='SI')  {jefatura.style.display='block'; jefatura.focus(); document.getElementById('jefaturaEtq').style.color='#000000';} else {jefatura.style.display='none'; jefatura.value ='0'; document.getElementById('jefaturaEtq').style.color='#D2DEF0';}}">
								<option value="">-SELECCIONE-</option>
								<option value="NO">NO</option>
								<option value="SI">SI</option>
						</select>
					</td>
					<td style="width: 100px; color:#D2DEF0;">
						<div id="jefaturaEtq">Indique tipo:</div>
					</td>
					<td style="width: 100px; color:#D2DEF0;">
						<select name="jefatura" id="jefatura" class="datospf" style="width: 190px; display:none;">
							<option value="">&nbsp;&nbsp;- - - - - - SELECCIONE - - - - - -</option>
							<option value="COORD CATEDRA">COORDINADOR DE CATEDRA</option>
							<option value="JEFE SECC">JEFE DE SECCION</option>
							<option value="JEFE COORD">JEFE DE COORDINACION</option>
				...
				<tr class="datosp">
					<td style="width: 350px;">Ejerce o ha ejercido otros Cargos en la Adm. P&uacute;blica:</td>
					<td style="width: 150px;">
					<select name="otrocS" id="ochS" class="datospf" 
						  style="width: 100px;" onChange="with(document.datos_p){ if (this.value =='SI')  {c_otroc.style.display='block'; c_otroc.focus(); datosotroc.style.display='block'; document.getElementById('otrocEtq').style.color='#000000';} else {c_otroc.style.display='none'; c_otroc.value ='0'; datosotroc.style.display='none'; document.getElementById('otrocEtq').style.color='#D2DEF0';}}">
							<option value="">-SELECCIONE-</option>
							<option value="NO">NO</option>
							<option value="SI">SI</option>
					</select>
					</td>
					<td style="width: 350px; color:#D2DEF0;" >
						<div id="otrocEtq">Indique Cuantos:</div>
					</td>
						
					<td>
						
							<INPUT TYPE="text" NAME="c_otroc" id="otroc" class="datospf" maxlength="2" style="width: 30px; display:none;" onKeyUp="validarN(this);">
							
							<INPUT TYPE="button" id="datosotroc" value="incluir datos" class="boton" style="width: 90px; display: none;" onClick="enviaOC();">
    ...
    <td width="750">
        ...
        <table align="center" border="0" cellpadding="1" cellspacing="2" 
		 width="740" style="border-collapse:collapse;border-color:white; border-style:solid; background:#D2DEF0;">
            <tbody>
                <tr class="datosp">
					<td style="width: 350px;">Ha dictado otras materias en la UNEXPO: &nbsp; 
					<select name="mathS" id="omathS" class="datospf" 
						  style="width: 100px;" onChange="with(document.datos_p){ if (this.value =='SI')  {c_math.style.display='block'; c_math.focus(); datosmh.style.display='block'; document.getElementById('mathEtq').style.color='#000000';} else {c_math.style.display='none'; c_math.value ='0'; datosmh.style.display='none'; document.getElementById('mathEtq').style.color='#D2DEF0';}}">
							<option value="">-SELECCIONE-</option>
							<option value="NO">NO</option>
							<option value="SI">SI</option>
					</select><BR>
				...
				<tr class="datosp">
					<td style="width: 350px;">Ha ejercido otros cargos en la UNEXPO: &nbsp; 
					<select name="otrochS" id="otrochS" class="datospf" 
		 ...
		 width="740" style="border-collapse:collapse;border-color:white; border-style:solid; background:#D2DEF0;">
            <tbody>
				...
				<tr class="datosp">
					...
					<td style="width: 60px;">
						<select name="cursosS" id="cursosS" class="datospf" 
							  style="width: 50px;" onChange="with(document.datos_p){ if (this.value =='SI')  {c_cursos.style.display='block'; c_cursos.focus(); datoscursos.style.display='block'; document.getElementById('cursosEtq').style.color='#000000';} else {c_cursos.style.display='none'; c_cursos.value ='0'; datoscursos.style.display='none'; document.getElementById('cursosEtq').style.color='#D2DEF0';}}">
								<option value="">-SEL-</option>
								<option value="NO">NO</option>
								<option value="SI">SI</option>
						</select>
					...
					<td class="datosp" style="width: 150px;">
				...
				<tr class="datosp">
					...
					<td style="width: 60px;">
						<select name="publiS" id="publiS" class="datospf" 
							  style="width: 50px;" onChange="with(document.datos_p){ if (this.value =='SI')  {c_publi.style.display='block'; c_publi.focus(); datospubli.style.display='block'; document.getElementById('publiEtq').style.color='#000000';} else {c_publi.style.display='none'; c_publi.value ='0'; datospubli.style.display='none'; document.getElementById('publiEtq').style.color='#D2DEF0';}}">
								<option value="">-SEL-</option>
								<option value="NO">NO</option>
								<option value="SI">SI</option>
						</select>
				...
				<tr class="datosp">
					...
					<td style="width: 60px;">
						<select name="concurS" id="concurS" class="datospf" 
							  style="width: 50px;" onChange="with(document.datos_p){ if (this.value =='SI')  {c_concur.style.display='block'; c_concur.focus(); datosconcur.style.display='block'; document.getElementById('concurEtq').style.color='#000000';} else {c_concur.style.display='none'; c_concur.value ='0'; datosconcur.style.display='none'; document.getElementById('concurEtq').style.color='#D2DEF0';}}">
								<option value="">-SEL-</option>
								<option value="NO">NO</option>
								<option value="SI">SI</option>
						</select>
				...
				<tr class="datosp">
					...
					<td style="width: 60px;">
						<select name="invesS" id="invesS" class="datospf" 
							  style="width: 50px;" onChange="with(document.datos_p){ if (this.value =='SI')  {c_inves.style.display='block'; c_inves.focus(); datosinves.style.display='block'; document.getElementById('invesEtq').style.color='#000000';} else {c_inves.style.display='none'; c_inves.value ='0'; datosinves.style.display='none'; document.getElementById('invesEtq').style.color='#D2DEF0';}}">
								<option value="">-SEL-</option>
								<option value="NO">NO</option>
								<option value="SI">SI</option>
						</select>
					...
					<td style="width: 60px;">
						<select name="comuS" id="comuS" class="datospf" 
							  style="width: 50px;" onChange="with(document.datos_p){ if (this.value =='SI')  {c_comu.style.display='block'; c_comu.focus(); datoscomu.style.display='block'; c_comu.value =''; document.getElementById('comuEtq').style.color='#000000';} else {c_comu.style.display='none'; c_comu.value ='0'; datoscomu.style.display='none'; document.getElementById('comuEtq').style.color='#D2DEF0';}}">
								<option value="">-SEL-</option>
								<option value="NO">NO</option>
								<option value="SI">SI</option>
						</select>
					...
					<td style="width: 80px; color:#D2DEF0;">
						<div id="comuEtq">Indique Cuantos:</div>
					</td>
					<td class="datosp" style="width: 30px;">
						<INPUT TYPE="text" NAME="c_comu" id="comu" class="datospf" maxlength="2" style="width: 30px; display:none;" onKeyUp="validarN(this);">
					</td>
					<td class="datosp" style="width: 70px;">
						<INPUT TYPE="button" id="datoscomu" value="incluir datos" class="boton" style="width: 90px; display: none;" onClick="enviaCO();">
					</td>
				...
				<tr class="datosp">
					...
					<td style="width: 60px;">
						<select name="tasS" id="tasS" class="datospf" 
							  style="width: 50px;" onChange="with(document.datos_p){ if (this.value =='SI')  {c_tas.style.display='block'; c_tas.focus(); datostas.style.display='block'; c_tas.value =''; document.getElementById('tasEtq').style.color='#000000';} else {c_tas.style.display='none'; c_tas.value ='0'; datostas.style.display='none'; document.getElementById('tasEtq').style.color='#D2DEF0';}}">
								<option value="">-SEL-</option>
								<option value="NO">NO</option>
								<option value="SI">SI</option>
						</select>
					...
					<td style="width: 80px; color:#D2DEF0;">
						<div id="tasEtq">Indique Cuantos:</div>
					</td>
					<td class="datosp" style="width: 30px;">
						<INPUT TYPE="text" NAME="c_tas" id="tas" class="datospf" maxlength="2" style="width: 30px; display:none;" onKeyUp="validarN(this);">
					</td>
					<td class="datosp" style="width: 70px;">
						<INPUT TYPE="button" id="datostas" value="incluir datos" class="boton" style="width: 90px; display: none;" onClick="enviaTA();">
					</td>
				...
				<tr class="datosp">
					...
					<td style="width: 60px;">
						<select name="ttgS" id="ttgS" class="datospf" 
							  style="width: 50px;" onChange="with(document.datos_p){ if (this.value =='SI')  {c_ttg.style.display='block'; c_ttg.focus(); datosttg.style.display='block'; c_ttg.value =''; document.getElementById('ttgEtq').style.color='#000000';} else {c_ttg.style.display='none'; c_ttg.value ='0'; datosttg.style.display='none'; document.getElementById('ttgEtq').style.color='#D2DEF0';}}">
								<option value="">-SEL-</option>
								<option value="NO">NO</option>
								<option value="SI">SI</option>
						</select>
					...
					<td style="width: 80px; color:#D2DEF0;">
						<div id="ttgEtq">Indique Cuantos:</div>
					</td>
					<td class="datosp" style="width: 30px;">
						<INPUT TYPE="text" NAME="c_ttg" id="ttg" class="datospf" maxlength="2" style="width: 30px; display:none;" onKeyUp="validarN(this);">
					</td>
					<td class="datosp" style="width: 70px;">
						<INPUT TYPE="button" id="datosttg" value="incluir datos" class="boton" style="width: 90px; display: none;" onClick="enviaTT();">
					</td>
...
alert('Presione el Boton "PROCESAR" para guardar los cambios'); 
return false;}} 
// Unhide 
// -->
