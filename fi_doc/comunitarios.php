	...
	<?for ($i=1;$i<=$comu;$i++){
		...
		<BR><div class="tit14" style="text-align:center;">
			...
			(Coloque los datos completos en todos los campos.)</span>
				...
				print "<tr>";
					if(isset($c[0])) {
						print "<td  colspan=\"3\"><div><input name='" . "titulo_" . $i ."' class=\"datospf\" style='width: 600px;' onKeyUp='validarL(this);' value='$c[0]'><INPUT TYPE='hidden' NAME='update' value='SI'></div></td>";
					}
					else {
						print "<td  colspan=\"3\"><div><input name='" . "titulo_" . $i ."' class=\"datospf\" style='width: 600px;' onKeyUp='validarL(this);'></div></td>";
					}
				print "</tr>";
				print "<tr>";
					print "<td>";
				...
				print "<tr>";
					if(isset($c[1])) {
						print "<td class=\"datosp\" style=\"width: 60px\">Ciudad:&nbsp;<div><input name='" . "ciudad_" . $i ."' class=\"datospf\" style='width: 200px;' onKeyUp='validarL(this);' value='$c[1]'><INPUT TYPE='hidden' NAME='update' value='SI'></div></td>";
					}
					else {
					...
					if(isset($c[2])) {
						print "<td class=\"datosp\" style=\"width: 160px\">Pais:&nbsp;<div><input name='" . "pais_" . $i ."' class=\"datospf\" style='width: 200px;' onKeyUp='validarL(this);' value='$c[2]'><INPUT TYPE='hidden' NAME='update' value='SI'></div></td>";
					}
					else {
					...
					if(isset($c[3])) {
						print "<td class=\"datosp\" style=\"width: 160px\">Año:&nbsp;<div><input name='" . "anio_" . $i ."' class=\"datospf\" style='width: 30px;' onKeyUp='validarN(this);' value='$c[3]'><INPUT TYPE='hidden' NAME='update' value='SI'></div></td>";
					}
					else {
						print "<td class=\"datosp\" style=\"width: 160px\">Año:&nbsp;<div><input name='" . "anio_" . $i ."' class=\"datospf\" style='width: 30px;' onKeyUp='validarN(this);'></div></td>";
					}
				print "</tr>";
