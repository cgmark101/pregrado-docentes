...
<title><?php echo $tProceso?> > Materias en Otros Lapsos</title>
...
<form name="datos_mh" method="POST" action="registrarmh.php">
		...
		<BR><div class="tit14" style="text-align:center;">
			...
			(Coloque los datos completos en todos los campos.)</span>
				...
				<tr>
					...
					<td class="datosp" style="width: 100px">
						En el Lapso:
					</td>
					<td class="datosp" style="width: 100px">
						Nivel
				...
				$mSQL = "select C_ASIGNA,ASIGNATURA,LAPSO,NIVEL ";
				$mSQL= $mSQL."from DMAT_H ";
				...
				print "<tr>";
					...
					if(isset($m[1])) {
						print "<td><div><input name='" . "asignatura_" . $i ."' class=\"datospf\" style='width: 300px;' onKeyUp='validarL(this);' value='$m[1]'></div></td>";
					}
					else{
						print "<td><div><input name='" . "asignatura_" . $i ."' class=\"datospf\" style='width: 300px;' onKeyUp='validarL(this);'></div></td>";
					}
					if(isset($m[2])) {
						print "<td><div><input name='" . "lapso_" . $i ."' class=\"datospf\" style='width: 55px;' maxlength='7' value='$m[2]'></div></td>";
					}
					else{
						print "<td><div><input name='" . "lapso_" . $i ."' class=\"datospf\" style='width: 55px;' maxlength='7'></div></td>";
					}
					if(isset($m[3])) {	
						print "<td><div><select name='" . "nivel_" . $i ."' class=\"datospf\" style='width: 100px;>'";
							print "<option value=\"$m[3]\">$m[3]</option>";
				...
				<tr>
					<td colspan="5" class="datosp2">
						Indicar el &uacute;ltimo Lapso en el cual la dict&oacute; EJ: 2007-2
					</td>
				</tr>
			</TABLE>
<BR>
...
<TR>
	...
	<td style="width: 300px;">
	<p align="center"><BR>
		<INPUT TYPE="submit" value="Cargar" name="cargar" class="boton"></p>
	</td>
</TR>
</TABLE>
