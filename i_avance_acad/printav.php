...
for ($x=0;$x<count($lista_e);$x++){
	...
	echo "<tr>";
	# numero
	echo "<td width=\"1px\" style=\"text-align:center;font-family:arial;font-size:6pt;font-weight:bold;\">".$nro."</td>";
	# expediente
	echo "<td width=\"25px\" style=\"padding-right:3px;padding-left:3px;text-align:center;font-family:arial;font-size:8pt;font-weight:bold;\">".$lista_e[$x][0]."</td>";
	# apellidos y nombres
