...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/docentes/avance_consulta_t/';
$urlDelSitio		= 'http://www.poz.unexpo.edu.ve/web/urace';

$lapsoProceso		= '2012-2';
$tLapso				= 'Lapso '.$lapsoProceso;
$laBitacora			= 'Q:/AppServ/www/log/pregrado/docentes/notas_consulta/consultas_avance_'.$lapsoProceso.'.log';
