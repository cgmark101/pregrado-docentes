...
<table border="0" width="680">
	...
	<tr><td class="instruc">
        <ul>
            ...
            Por favor introduzca el n&uacute;mero de acta correspondiente a la asignatura y secci&oacute;n que desee consultar y presione el boton CONSULTAR</li>
			<li style="list-style-type: square;">
            La consulta comenzar&aacute; solamente despu&eacute;s de 
			pulsar el bot&oacute;n "CONSULTAR".</li>
            <li style="list-style-type: square;">
...
P001pi;
	...
	print <<<P001
             <li style="list-style-type: square;">
            Esta consulta est&aacute; sujeta
