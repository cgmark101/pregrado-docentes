...
if ($inscHabilitada){
	...
	print <<<x001
		...
		Disculpe, el proceso se ha habilitado para ser cargado por el Avance Academico 2010-1<br>
		Si tiene alguna duda o inconveniente por favor dir&iacute;jase a <strong>Control de Estudios</strong>.
		</font>
x001
;
}
...
?>
    ...
    <tr>
      ...
      <ul>
        <li>Si no posee la clave o la olvid&oacute;, puedes solicitarla en la Unidad 
...
carnet ORIGINAL. No se aceptan fotocopias. </li>
