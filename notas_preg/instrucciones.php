...
<table border="0" width="680">
	...
	<tr><td class="instruc">
        <ul>
            ...
            Por favor introduzca el n&uacute;mero de acta correspondiente a la asignatura y secci&oacute;n que desee cargar las calificaciones y presione el boton CARGAR</li>
			<li style="list-style-type: square;">
            El proceso de carga comenzar&aacute; solamente despu&eacute;s de 
			pulsar el bot&oacute;n "Cargar".</li>
            <li style="list-style-type: square;">
...
P001pi;
	...
	print <<<P001
             <li style="list-style-type: square;">
            La carga de calificaciones est&aacute; sujeta
