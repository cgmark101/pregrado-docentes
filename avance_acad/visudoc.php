...
<tr>
    ...
    <p align="center" class="titulo">Se encuentra en el modulo de visualizacion de actas</p><br><p align="center" class="titulo"> A continuaci&oacute;n seleccione la operacion a realizar. </p>
	</td>
  </tr>
  <tr>
...
<?PHP
if($cod==124){
$conex = new ODBC_Conn($basededatos,$usuariodb,$clavedb,TRUE,'pruebas.log');
...
$resultado = $conex->result;
			...
			/*if($car==1) $mSQL  = "select distinct c.asignatura,a.c_asigna,b.pensum from tblaca004 a,tblaca009 b,tblaca008 c where a.c_asigna like '300%' and b.pensum='5' and c.c_asigna=a.c_asigna order by c.asignatura asc";
			
			if($car==2) $mSQL  = "select distinct c.asignatura,a.c_asigna,b.pensum from tblaca004 a,tblaca009 b,tblaca008 c where a.c_asigna like '311%' and b.pensum='5' and c.c_asigna=a.c_asigna order by c.asignatura asc";
			
			if($car==3) $mSQL  = "select distinct c.asignatura,a.c_asigna,b.pensum from tblaca004 a,tblaca009 b,tblaca008 c where a.c_asigna like '355%' and b.pensum='5' and c.c_asigna=a.c_asigna order by c.asignatura asc";
			
			if($car==4) $mSQL  = "select distinct c.asignatura,a.c_asigna,b.pensum from tblaca004 a,tblaca009 b,tblaca008 c where a.c_asigna like '322%' and b.pensum='5' and c.c_asigna=a.c_asigna order by c.asignatura asc";
			
			if($car==5) $mSQL  = "select distinct c.asignatura,a.c_asigna,b.pensum from tblaca004 a,tblaca009 b,tblaca008 c where a.c_asigna like '333%' and b.pensum='5' and c.c_asigna=a.c_asigna order by c.asignatura asc";
			
			if($car==6) $mSQL  = "select distinct c.asignatura,a.c_asigna,b.pensum from tblaca004 a,tblaca009 b,tblaca008 c where a.c_asigna like '340%' and b.pensum='5' and c.c_asigna=a.c_asigna order by c.asignatura asc";*/
			...
			switch ($car) {
				case 1:
					$mSQL.= "'300%' AND a.c_asigna in (SELECT c_asigna FROM D_TEMAS WHERE c_asigna like '300%') ";
					break;
				case 2:
					$mSQL.= "'311%' ";
					break;
...
print <<<TABLA02
		<tr>
			<td>{$conex->result[0][5]} - {$conex->result[0][0]}</td>
			<td>{$conex->result[0][1]}, {$conex->result[0][2]}</td>
			<td>{$conex->result[0][3]}</td>
