...
<body>
<?php
require_once('inc/config.php');//este tambien esta agregado en cada funcion
...
$conex = new ODBC_Conn($basededatos,$usuariodb,$clavedb,TRUE,'consulta_avance'.date(m).'-'.date(Y).'.log');
