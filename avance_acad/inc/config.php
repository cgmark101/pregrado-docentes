...
//$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].':8085/web/urace/pregrado/docentes/avance_acad/';
//$urlDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].':8085/web/';
...
$laBitacora			= $_SERVER[DOCUMENT_ROOT].'/log/pregrado/docentes/avance/avance_acad_'.date(m).'-'.$lapsoProceso.'.log';
