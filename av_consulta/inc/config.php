...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/docentes/av_consulta/';
$urlDelSitio		= 'http://www.poz.unexpo.edu.ve/web/urace';

$lapsoProceso		= '2011-1I';
$tLapso				= 'Lapso '.$lapsoProceso;
$laBitacora			= 'C:/AppServ/www/log/pregrado/docentes/notas_consulta/consultas_avance_'.$lapsoProceso.'.log';
$inscHabilitada		= true;
