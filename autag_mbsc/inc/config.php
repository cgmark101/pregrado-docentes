...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/docentes/autag_mbsc/';
$urlDelSitio		= 'http://www.poz.unexpo.edu.ve/web/urace/';

$lapsoProceso		= '2013-1';
$tLapso				= ' Lapso '.$lapsoProceso;
$laBitacora			= $_SERVER[DOCUMENT_ROOT].'/log/pregrado/docentes/autoriza_ag/procesa_s_cola_'.$lapsoProceso.'.log';
