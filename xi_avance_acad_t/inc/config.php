...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/docentes/i_avance_acad_t/';
...
$laBitacora			= $_SERVER[DOCUMENT_ROOT].'/log/pregrado/docentes/avance/avance_acad_tardio_'.date(m).'-'.$lapsoProceso.'.log';
