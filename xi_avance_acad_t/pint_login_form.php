...
if ($inscHabilitada){
	...
	print <<<x001
		...
		Disculpe, el proceso finaliz&oacute; el 30/09/2014 a las 8:45 am.<br><br>En caso que desee cargar sus calificaciones, por favor solicite autorizaci&oacute;n en la Direcci&oacute;n Acad&eacute;mica.
		<!-- Disculpe, el sistema est&aacute; en mantenimiento.<br>Abre nuevamente el 16/11/2013 a partir de las 4:00 pm<br> -->
		</div><br>
x001
;
}
...
?>		  </p>
			...
			<!-- <div style="font-family:arial; font-size:16px; color:red;text-align:center;">
		El sistema estar&aacute; disponible hasta el lunes 17/10/2011 a las 8:00am.
		<br>El proceso de carga no contar&aacute; con soporte t&eacute;cnico.<br>Usted quedar&aacute; registrado como tard&iacute;o.
		</div> -->
    </td>
  </tr>
