		...
		<li>
			...
			<li class="current">
				...
				<ul>
					...
					<li>
						<a href="cargar_exp.php">Práctica Profesional por Experiencia o TSU</a>
						
					</li>
					<!--<li>
						<a href="cargar_eq.php">Equivalencia o Reválida</a>
			...
			<li>
				...
				<ul>
							...
							<li><a href="manuales/pract_prof_exp.pdf" target="blank">Manual de Usuario de Práctica Profesional por Exp. o T.S.U titulado</a></li>
							<li><a href="manuales/eq_rev.pdf" target="blank">Manual de Usuario Equivalencias o Reválidas</a></li>
