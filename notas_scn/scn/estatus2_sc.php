...
$mSQL  = "SELECT DISTINCT lapso FROM dace004 WHERE lapso='$lap' ";  
...
<table width="720" border="0" align="center">
  ...
  <tr>
  <td> <form action="datos_e2_sc.php" method="post" name="cedula" id="cedula" >
  <span class="datos_tabla">Cédula de Identidad: </span>
  <label class="alert">
  <input name="ci_e" type="text" class=":required :number :wait;500"><input name="Aceptar" type="submit" value="Aceptar">
  </label>
