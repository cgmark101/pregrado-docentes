...
$mSQL  = "SELECT acta,c_asigna,seccion,lapso FROM sc_exp_temp ORDER BY apellidos ASC";     
...
<table width="800" border="0" align="center">
  ...
  <tr>
    ...
    <td><div align="center" class="enc_materias Estilo1">ACREDITACION POR EXPERIENCIA</div></td>
...
$conex = new ODBC_Conn($ODBC_name,$usuario_db,$password_db,TRUE,$log);
$mSQL  = "SELECT exp_e,apellidos,apellidos2,nombres,nombres2,observacion, ci_e FROM sc_exp_temp ORDER BY apellidos ASC";     
...
<?php include('procesar_all_exp.php'); ?>
</table>
