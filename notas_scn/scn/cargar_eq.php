...
<table width="700" border="0" align="center">
  ...
  <tr>
    ...
    <p><font style="font-size: 11px">Introduzca el Lapso Acad&eacute;mico en donde establecer&aacute; el cambio de estatus por Equivalencia o Reválida</p></td>
  </tr>
  <tr>
    <td><form " method="post" action="estatus2_eq.php">
