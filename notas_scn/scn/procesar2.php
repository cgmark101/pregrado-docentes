...
<link href="css/estilo.css" rel="stylesheet" type="text/css"><table width="650" border="0" align="center">
  <tr>
...
if($user=='0'):
$dSQL="SELECT exp_e,apellidos,apellidos2,nombres,nombres2,ci_e,calificacion,letras,observacion,acta,lapso,c_asigna FROM sc_tg_temp ORDER BY acta ASC";
else:
$dSQL="SELECT exp_e,apellidos,apellidos2,nombres,nombres2,ci_e,calificacion,letras,observacion,acta,lapso,c_asigna FROM sc_tg_temp WHERE c_asigna='$c_asignad' ORDER BY 11,12,10,2,3,4,5 ASC";
endif;
...
<table width="650" border="0" align="center">
  ...
  <tr>
    <td height="20" colspan="6" class="enc_p"><strong> </strong> </td>
...
//elimino campos sc_temp1
$conex = new ODBC_Conn($ODBC_name,$usuario_db,$password_db,TRUE,$log);
$mSQL  = "DELETE FROM sc_temp1 WHERE 1";     
$conex->ExecSQL($mSQL,__LINE__,true);
$ok=$conex->fmodif;
*/
include('procesar_all.php'); ?>
</table>

<script type="text/javascript">
function proceso() {
     if (window.confirm("Recuerde imprimir, Puede realizar las consultas de las actas cargadas desde el menu principal")) {
		window.opener.location = 'index_0.php';
