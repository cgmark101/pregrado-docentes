...
<?php
//if (empty($actap)):
$dSQL="SELECT acta, lapso, seccion, exp_e, apellidos, apellidos2, nombres, nombres2,ci_e, c_asigna FROM sc_pp_temp ORDER BY lapso ASC";
//else:
//$dSQL="SELECT acta, lapso, seccion, exp_e, apellidos, apellidos2, nombres, nombres2,ci_e, c_asigna FROM pp_temp WHERE acta='$actap' ORDER BY lapso ASC";
//endif;
...
<label>
  ...
  <?php
  if($fila >= '1'): 
  echo '<td class="datospd" align="right"> <a href="#" onClick="mensaje_pp(this)"><input type="submit" name="Submit" value="Procesar" /></a></td>
  </label>';
  else:
  echo ' ';
  endif;?>
