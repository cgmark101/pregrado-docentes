...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/docentes/notas_scn/';
$urlDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace';

$lapsoProceso		= '2020-E';
$tLapso				= ' Lapso '.$lapsoProceso;
$laBitacora			= $_SERVER[DOCUMENT_ROOT].'/log/pregrado/docentes/notas-scn_'.$lapsoProceso.'.log';
...
if ($modoInscripcion == '1'){
	...
	$tProceso	= 'Carga de Notas Serv. Comunitario, Trab. de Grado y Pract. Profesional';
}
