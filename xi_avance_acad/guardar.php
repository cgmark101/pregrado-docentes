...
global $conex;
//$conex = new ODBC_Conn($basededatos,$usuariodb,$clavedb,TRUE,$laBitacora);
$mSQL  = "select b.apellidos||',  '||nombres,a.exp_e,a.NOTA1,a.nota2,a.nota3,a.nota4,a.nota5,a.nota6,a.nota7,a.nota8,a.nota9,a.nota10,a.nota11,a.nota12,a.nota13,a.nota14,a.nota15,a.nota16,a.nota17,a.nota18,a.nota19,a.nota20,a.NOTA21,a.NOTA22,a.NOTA23,a.NOTA24,a.NOTA25,a.NOTA26,a.NOTA27,a.NOTA28,a.NOTA29,a.NOTA30,a.NOTA31,a.NOTA32,a.NOTA33,a.NOTA34,a.NOTA35,a.total100,a.total9,c.status from N_ESTU a,dace002 b,dace006 c where a.acta='$nacta' and a.lapso='$nlapso' and a.C_ASIGNA='$nc_asigna' and a.EXP_E=b.EXP_E and c.acta='$nacta' and c.lapso='$nlapso' and c.C_ASIGNA='$nc_asigna' and a.EXP_E=c.EXP_E and c.status in ('7','A','2','R') order by b.apellidos asc";
$conex->ExecSQL($mSQL,__LINE__,true);
$result = $conex->result;
return $result;
}
...
$resultado = $conex->result;
			...
			switch ($car) {
				case 1:
					$mSQL.= "a.c_asigna like '30%' AND a.c_asigna in (SELECT c_asigna FROM D_TEMAS WHERE lapso='".$lapsoProceso."' and c_asigna like '30%') ";
					break;
				case 2:
					$mSQL.= "a.c_asigna like '31%' AND a.c_asigna in (SELECT c_asigna FROM D_TEMAS WHERE lapso='".$lapsoProceso."' and c_asigna like '31%') ";
					break;
				case 3:
					/*$mSQL.= "a.c_asigna like '35%' AND a.c_asigna in (SELECT c_asigna FROM D_TEMAS WHERE lapso='".$lapsoProceso."' and c_asigna like '35%') ";*/
					$mSQL.= "((a.c_asigna like '35%' AND a.c_asigna in (SELECT c_asigna FROM D_TEMAS WHERE lapso='".$lapsoProceso."' and c_asigna like '35%')) OR (a.c_asigna = '300213' or a.c_asigna='300313'))";
					break;
				case 4:
...
<table>
  ...
  <tr>
	...
	<tr><td class="datona">
	<p class="enc_p"><strong>TEMAS AGREGADOS</strong></p>
	<hr size="1">
		<?php
		$cont=0;
	...
	<tr><td class="datona" >
	<p class="enc_p"><strong>TEMAS ELIMINADOS</strong></p>
	<hr size="1">
		<?php
		$cont=0;
		while($modct[$cont][8]!=NULL){
	...
	<tr><td class="datona">
	<p class="enc_p"><strong>MODIFICACIONES A LA DESCRIPCI&Oacute;N DE LOS TEMAS</strong></p>
	<hr size="1">
		<?php
		//require_once("inc/odbcss_c.php");
		$cont=0;
	...
	<tr><td class="datona">
	<p class="enc_p"><strong>MODIFICACIONES AL PORCENTAJE DE LOS TEMAS</strong></p>
	<hr size="1">
		<?php
		//require_once("inc/odbcss_c.php");
		$cont=0;
	...
	<tr><td  class="datona">
	<p class="enc_p"><strong>MODIFICACIONES A LAS CALIFICACIONES DE ESTUDIANTES</strong></p>
	<hr size="1">
	<?php
	//require_once("inc/odbcss_c.php");
	//$conex = new ODBC_Conn($basededatos,$usuariodb,$clavedb,TRUE,$laBitacora);
	$cont=0;
	//echo "echo: ".$modn[$cont][4];
	//print_r($modn);
...
<tr><td><?PHP include("datosdemate.php"); ?></td></tr>
  <tr>
	...
	<?php
	echo  '<table border="1" cellspacing="1" class="datotabla" style="border-collapse:collapse;">
