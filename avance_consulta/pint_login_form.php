...
<table id="table1" style="border-collapse: collapse;background: url(imagenes/fondo_index.png) no-repeat" border="0" cellpadding="0" cellspacing="1" width="100%" align="center"><tbody>
	...
	<td width="750" colspan="3">
          <p align="center" style="font-family:arial; font-weight:bold; font-size:25px;color:#FFFF00;" class="instruc">
<?php			echo $tProceso .' <span style="text-decoration:blink;">'. $tLapso.'</span>'; 
?>		  </p>
    </td>
  </tr>
