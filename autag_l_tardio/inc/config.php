...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/docentes/autag_l_tardio/';
$urlDelSitio		= 'http://www.poz.unexpo.edu.ve/web/urace/';

$lapsoProceso		= '2012-1';
$tLapso				= ' Lapso '.$lapsoProceso;
$laBitacora			= 'C:/AppServ/www/log/pregrado/docentes/autoriza_ag/procesa_cola_tardio_'.$lapsoProceso.'.log';
$inscHabilitada		= false;
$modoInscripcion	= '1'; // 1: Inscripcion, 2: Inclusion y Retiro

if ($modoInscripcion == '1'){
	$tProceso	= 'Autorizaci&oacute;n de Agregados de Estudiantes por el Docente';
}
