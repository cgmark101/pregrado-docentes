...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/docentes/autoriza_ag/';
$urlDelSitio		= 'http://www.poz.unexpo.edu.ve/web/urace/';

$lapsoProceso		= '2011-1';
$tLapso				= ' Lapso '.$lapsoProceso;
$laBitacora			= 'Q:/AppServ/www/log/pregrado/docentes/autoriza_ag/procesa_cola_'.$lapsoProceso.'.log';
