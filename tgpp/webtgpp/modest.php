...
<body onload="clickMenu('menu')">
	...
	$sql1="select CI_E, NOMBRES, APELLIDOS, C_UNI_CA from dace002 where CI_E = '$_SESSION[cedula]'";
			...
			<tr height="280" style="background: url(imagenes/fondo_unexpox.png) no-repeat">
				...
				<li class="sub">SOLICITUDES
				    <ul>
						...
						$flagtg=0;
						$flagpp=0;
						$sql2="select TIPO_PASANTIA from sol_tgpp where CI_E = '$_SESSION[cedula]'and TIPO_PASANTIA = 2";
						...
						$sql2="select TIPO_PASANTIA from sol_tgpp where CI_E = '$_SESSION[cedula]'and TIPO_PASANTIA = 1";
						$conex1 -> ExecSQL($sql2,__LINE__,true);
						$fila = $conex1->filas;
						if ($fila==1)
						{
