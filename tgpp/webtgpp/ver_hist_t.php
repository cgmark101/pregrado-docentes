...
<body>
	...
	<form name="Solicitud" action="actualizarlisto.php" method="post" onSubmit="return validar(this)">
		...
		if(true)
		{
		    ...
		    $sql1="select * from sol_solicitudes where EXP_E= '$reg[EXP_E]' and TIPO_PASANTIA='1' AND TIPO_SOLICITUD='2' ";
		    $conex -> ExecSQL($sql1,__LINE__,true);
		    $fila1 = $conex->filas;
		    ...
		    if ($fila1==1){
				...
				/*$sql="select * from sol_solicitudes where EXP_E= '$reg[EXP_E]' and TIPO_PASANTIA='1' AND TIPO_SOLICITUD='2' ";
				$conex -> ExecSQL($sql,__LINE__,true);*/
		...
		<tr><td colspan="5"><font style="font-size: 5px;">&nbsp;</font></td></tr>
    		<?php
		    $sql1 = "SELECT N_PROYECTO,FECHA_I,FECHA_C,FECHA_L,ID_ESTATUS,APELLIDO_TI,NOMBRE_TI,CEDULA_TI,TELEFONO_TI,CORREO_TI,CEDULA_TA,CEDULA_JC,CEDULA_JS ";
			$sql1.= "FROM sol_historial WHERE CI_E='$_REQUEST[id]' AND TIPO_PASANTIA='$_REQUEST[as]' ";
			$sql1.= "UNION ";
			 $sql1 = "SELECT N_PROYECTO,FECHA_I,FECHA_C,FECHA_L,ID_ESTATUS,APELLIDO_TI,NOMBRE_TI,CEDULA_TI,TELEFONO_TI,CORREO_TI,CEDULA_TA,CEDULA_JC,CEDULA_JS ";
			$sql1.= "FROM sol_tgpp WHERE CI_E='$_REQUEST[id]' AND TIPO_PASANTIA='$_REQUEST[as]' ";
