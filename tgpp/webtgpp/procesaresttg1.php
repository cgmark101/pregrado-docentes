...
<head>
	...
	$sql2="select CI_E, TIPO_PASANTIA from sol_tgpp where CI_E = '$_SESSION[cedula]' and TIPO_PASANTIA = 2";
	...
	if ($fila0==1)
	{
		...
		{
		# OJO MODIFICAR INSERT para datos de TI
		  if($_SESSION['especialidad']==5)
		  {
		    $sql2="insert into sol_tgpp (CI_E, TIPO_PASANTIA, n_proyecto, fecha_i, fecha_c, fecha_l, cedula_TA, id_estatus,c_uni_ca)
		    values ('$_SESSION[cedula]','$_SESSION[TIPO_PASANTIA]','$_REQUEST[nom_proyecto]','$_REQUEST[Sel_Fecha1]','$_REQUEST[Sel_Fecha]','$fecha_l','$_REQUEST[ced]',1,'$_SESSION[especialidad]')";
		    $conex1 -> ExecSQL($sql2,__LINE__,true);
		  }
		  else
		  {
