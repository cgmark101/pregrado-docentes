...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/docentes/tgpp/';
...
$laBitacora			= $_SERVER[DOCUMENT_ROOT].'/log/pregrado/docentes/tgpp/tgpp_'.date(m).'-'.$lapsoProceso.'.log';
...
if ($modoInscripcion == '1'){
	$tProceso	= 'Gesti&oacute;n de Trabajo de Grado - Práctica Profesional';
}
