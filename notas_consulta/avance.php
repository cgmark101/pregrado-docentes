...
print <<<THEAD1
        ...
        <tr>
			<td width="1%" style="text-align:center;font-family:arial;font-size:6pt;font-weight:bold;">
			#
            </td>
			<td width="9%" style="text-align:center;font-family:arial;font-size:6pt;font-weight:bold;">
				EXPED
			</td>
			<td width="30%" style="text-align:center;font-family:arial;font-size:6pt;font-weight:bold;">
				APELLIDOS Y NOMBRES
			</td>
			
THEAD1;

# Genero dinamicamente filas según $cant_eva
for ($i=1;$i<=$cant_eva;$i++){
...
for ($x=0;$x<count($lista_e);$x++){
	...
	# apellidos y nombres
	echo "<td width=\"5px\"><table width=\"100%\"><tr><td style=\"padding-left:5px;font-family:arial;font-size:6pt;font-weight:normal;\">".$lista_e[$x][1]."</td><td style=\"text-align:right;padding-right:5px;font-family:arial;font-size:5pt;font-weight:normal;\">".$estatus."</td>
	</tr></table></td>";
...
print <<<PIE
		...
		<div align="center" id="oculto" style="text-align:center;"><input type="button" value="Imprimir Avance" onClick="imprimir();">&nbsp;&nbsp;<input type="button" value="Cerrar" onClick="window.close();"></div>
