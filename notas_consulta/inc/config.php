...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/docentes/notas_consulta/';
$urlDelSitio		= 'http://www.poz.unexpo.edu.ve/web/urace';


$lapsoProceso		= '2022-2';
$tLapso				= ' Lapso '.$lapsoProceso;
$laBitacora			= $_SERVER[DOCUMENT_ROOT].'/log/pregrado/docentes/notas_consulta/consultas_';
