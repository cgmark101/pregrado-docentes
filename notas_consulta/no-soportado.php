...
<table border="0" width="750">
		...
		<tr><td colspan="3" style="font-family: Arial;"><br><br>Disculpe. Su navegador no est&aacute; soportado.
		Utilice <a href="http://www.mozilla-europe.org/es/firefox/" target="_blank" class="linkopacity">
				<IMG SRC="/web/img/getff.png" WIDTH="150" HEIGHT="40" BORDER="0" ALT="Navegador Mozilla Firefox 3">	
