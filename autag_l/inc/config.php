...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/docentes/autag_l/';
$urlDelSitio		= 'http://www.poz.unexpo.edu.ve/web/urace/';

$lapsoProceso		= '2013-1';
$tLapso				= ' Lapso '.$lapsoProceso;
$laBitacora			= 'C:/AppServ/www/log/pregrado/docentes/autoriza_ag/procesa_cola_'.$lapsoProceso.'.log';
