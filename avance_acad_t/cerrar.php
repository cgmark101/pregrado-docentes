...
if ($_SERVER['HTTP_REFERER'] != $raizDelSitio.'cante.php'){
	die ("<script languaje=\"javascript\"> alert('ACCESO PROHIBIDO'); </script>");
}

$conex = new ODBC_Conn($basededatos,$usuariodb,$clavedb,TRUE,"cierre_actas_".$lapso);
...
<script languaje="javascript"> 
	function confirmar() {
		...
		envia = confirm('Está intentado cerrar el acta número '+acta+' correspondiente a:\n\n - Asignatura: '+asignatura+'\n - Código: '+c_asigna+'\n - Seccion: '+seccion+'\n - Lapso: '+lapso+'\n\nUna vez cerrada no podrá realizar modificación alguna.\n\n____________________________________________________________\n\n				¿Confirma el cierre de esta acta?\nPor favor presione ACEPTAR para confirmar. CANCELAR para declinar.');
