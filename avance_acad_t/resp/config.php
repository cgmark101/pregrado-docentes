...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/docentes/avance_a/';
$urlDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/';
$tLapso				= ' Lapso 2009-2';
$lapsoProceso		= '2009-2';
$laBitacora			= 'C:/AppServ/www/log/pregrado/docentes/avance/modif_avance_acad_2009-2.log';
$inscHabilitada		= true;
...
if ($modoInscripcion == '1'){
	$tProceso	= 'PRUEBA Avance Academico';
}
